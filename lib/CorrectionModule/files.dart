class files
{
  ...
  static get_rangesFile(String pose_name)
  {
    ...
    if("tree-l".toLowerCase().contains(pose_name.toLowerCase()))//left
    //if("tree-l" == pose_name)
    {
...
""";
    ...
    else if("warrior 2" == pose_name) //right bended
    {
      //|left_knee, 313.34, 344.5, 31.16
      ranges = """right_knee, 98.52, 128.91 
|left_knee, 163.57, 185.01 
|left_shoulder, 252.87, 273.27 
|right_shoulder, 87.91, 111.9
|split, 218.57, 252.37
|right_elbow, 170.6, 185.49
|left_elbow, 174.23, 190.08 
""";
    }
